...
public class frmMantenimientoPuesto extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsPuesto> listaAul = puestos.getListadoPue();
        tablaUsuarios.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaAul.size(); i++) {
            dato[0] = listaAul.get(i).getCodigoPuesto();
            dato[1] = listaAul.get(i).getNombrePuesto();
            dato[2] = listaAul.get(i).getEstatusPuesto();
            modelo.addRow(dato);
        }       
    }
