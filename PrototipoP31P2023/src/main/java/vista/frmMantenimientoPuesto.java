...
public class frmMantenimientoPuesto extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("nombre_puesto");
        modelo.addColumn("estatus_puesto");
        clsPuesto puestos = new clsPuesto();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsPuesto> listaPue = puestos.getListadoPue();
        tablaPuesto.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaPue.size(); i++) {
            dato[0] = listaPue.get(i).getCodigoPuesto();
            dato[1] = listaPue.get(i).getNombrePuesto();
            dato[2] = listaPue.get(i).getEstatusPuesto();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsPuesto puestos = new clsPuesto();
        puestos.setCodigoPuesto(txtbuscado.getText());
        registrosBorrados=puestos.setBorrarPuesto(puestos);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsPuesto puestos = new clsPuesto();
        puestos.setCodigoPuesto(txtCodigo.getText());
        puestos.setNombrePuesto(txtNombre.getText());
        puestos.setEstatusPuesto(txtContrasena.getText());
        puestos.setIngresarPuesto(puestos);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        puestos.setCodigoPuesto(txtbuscado.getText());        
        puestos = puestos.getBuscarInformacionPuestoPorCodigo(puestos);
        System.out.println("Usuario retornado:" + puestos);        
        txtNombre.setText(puestos.getNombrePuesto());
        txtContrasena.setText(puestos.getEstatusPuesto());
...
//        // TODO add your handling code here:
        ...
        puestos.setNombrePuesto(txtNombre.getText());
        puestos.setEstatusPuesto(txtContrasena.getText());
        puestos.setModificarPuesto(puestos);
